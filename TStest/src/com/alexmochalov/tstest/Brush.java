...
public class Brush extends ImageView{
	...
	public void setRadius(int radius, boolean main){
		...
		this.pixel = new Pixel((short)255);
...
//                canvas.drawBitmap(icon, rectS, rectD, paint);
	...
	public void setPixel(Pixel readObject) {
		pixel = readObject;
		rgb = Var.ryb2rgb(this.pixel);
		invalidate();
	}
	...
	public void setPixel(String str1, String str2, String str3, String str4) {
		...
		*/
		pixel.red = (short) Integer.parseInt(str1);
		pixel.yellow = (short) Integer.parseInt(str2);
		pixel.blue = (short) Integer.parseInt(str3);
		pixel.white = (short) Integer.parseInt(str4);
